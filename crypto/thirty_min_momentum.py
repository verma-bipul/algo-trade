"""
Strategy 4: 30-Minute Candle Momentum on BTC/USD

Every 30 minutes:
- Green candle -> buy, hold for 30 min, sell next cycle
- Red candle -> skip
"""
...
logger = get_logger("thirty_min_momentum")
tracker = PortfolioTracker("thirty_min_momentum", "30-Min Momentum BTC", symbol=SYMBOL, initial_cash=BUDGET)
